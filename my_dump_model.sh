...
--audio_model_name_or_path "/mnt/user/bufan/zhanchen/whisper-large-v3" \
--text_model_name_or_path "/mnt/user/zhangyuhao/LLM/llama3-instruct/llama_3.2_3B" \
--data_path "/mnt/speech/zhangyuhao/ACLlama_mt/data/libri_train_update.json" \
--bf16 True \
